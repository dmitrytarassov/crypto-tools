...
export declare namespace IStrategyManager {
  export type DeprecatedStruct_WithdrawerAndNonceStruct = {
    withdrawer: string;
    nonce: BigNumberish;
  };

  export type DeprecatedStruct_WithdrawerAndNonceStructOutput = [
    string,
    BigNumber
  ] & { withdrawer: string; nonce: BigNumber };

  export type DeprecatedStruct_QueuedWithdrawalStruct = {
    strategies: string[];
    shares: BigNumberish[];
    staker: string;
  ...
  export type DeprecatedStruct_QueuedWithdrawalStructOutput = [
    string[],
    BigNumber[],
    string,
...
export interface DelegationManagerInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "earningsReceiver",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "migrateQueuedWithdrawals",
    values: [IStrategyManager.DeprecatedStruct_QueuedWithdrawalStruct[]]
  ): string;
  encodeFunctionData(
...
export interface WithdrawalMigratedEventObject {
  oldWithdrawalRoot: string;
  newWithdrawalRoot: string;
}
export type WithdrawalMigratedEvent = TypedEvent<
  [string, string],
  WithdrawalMigratedEventObject
>;

export type WithdrawalMigratedEventFilter =
  TypedEventFilter<WithdrawalMigratedEvent>;
...
export interface DelegationManager extends BaseContract {
  ...
  functions: {
    ...
    migrateQueuedWithdrawals(
      withdrawalsToMigrate: IStrategyManager.DeprecatedStruct_QueuedWithdrawalStruct[],
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "WithdrawalMigrated(bytes32,bytes32)"(
      oldWithdrawalRoot?: null,
      newWithdrawalRoot?: null
    ): WithdrawalMigratedEventFilter;
    WithdrawalMigrated(
      oldWithdrawalRoot?: null,
      newWithdrawalRoot?: null
    ): WithdrawalMigratedEventFilter;
